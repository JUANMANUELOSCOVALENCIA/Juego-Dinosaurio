...
function GameOver() {
    ...
    // Mostrar formulario para ingresar nombre y puntaje
    var playerName = prompt("¡Game Over! Ingresa tu nombre para guardar tu puntaje:");

    if (playerName) {
        // Almacenar el puntaje y el nombre en el almacenamiento local
